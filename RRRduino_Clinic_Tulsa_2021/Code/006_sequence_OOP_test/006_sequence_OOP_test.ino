 ...
 * 
 * To flash three LEDs, at pin 13, pin 12 and pin 11 in sequence, but roll them!
 * 
...
//
// Try drastic changes in the ONTIME and OFFTIME for any of the LEDs, forget that they might be in sequence. Use DELAY 0
//
